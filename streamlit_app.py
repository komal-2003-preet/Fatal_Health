...
# ----------- FETAL HEALTH PREDICTION PAGE -----------
    ...
    "accelerations": st.number_input("Accelerations", 0.0, 1.0, 0.02),
    ...
    "abnormal_short_term_variability": st.number_input("Abnormal Short Term Variability", 0.0, 10.0, 0.0),
    ...
    "histogram_width": st.number_input("Histogram Width", 0, 100, 50),
    "histogram_min": st.number_input("Histogram Min", -50, 50, 0),
